...
Card arts are sourced from [Scryfall's API][scryfall:api] without any
modification and are copyright _Wizards of the Coast_ or their respective
artists for older sets. For cropped arts where the artist line of a card is not
visible, the artists are credited in the accessible text.
...
For questions, corrections, or contributions, visit the [GitHub
repository][code:repository] or reach out through the [Doomsday
Discord](/discord).
...
[icons:mui]: https://mui.com/material-ui/material-icons
