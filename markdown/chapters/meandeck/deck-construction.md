...
make your deck as consistent as possible for mulliganing purposes. Some people
include one or two Cabal Rituals as sideboard cards for certain matchups.
...
include into the deck as it really helps push through a lot of matchups. In
control lists it tends to not be included at all, instead being replace with
...
accrued with it. Outside of this interaction though, it is likely worse than
Preordain despite the lower cost as it decreases your potential blue count for
Force of Will and can be slow/not contribute to same turn wins when you need
them.
...
total can be pressured and you may not have the two life available to cycle a
Street Wraith, even though it is probably the more useful of the two outside of
the combo.
